...
export default function UpdateListing() {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      const res = await fetch(`/api/listning/get/${listingId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      const res = await fetch(`/api/listning/update/${params.listingId}`, {
        method: "POST",
        headers: {
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <button
            ...
            className="bg-gray-700 rounded-lg p-3 text-white uppercase hover:opacity-95 disabled:opacity-80 "
          >
